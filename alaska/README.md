# Fairbanks Winter Trip Research (Dec 23 - Dec 31)

Research notes for a Fairbanks, Alaska winter trip, saved per topic.

## Tour & activity files

- [Dog Mushing](dog-mushing.md) — dog sledding tour operators, pricing, schedule, pickup
- [Snowmobile](snow-mobile.md) — guided snowmobile/snowmachine tours, pricing, schedule, pickup
...
- [Winter Gear / Clothing / Boot Rental](rental.md) — where to rent cold-weather clothing for the trip
